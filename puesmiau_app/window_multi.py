...
class Gui():
	...
	def DescargarBtn_accion(self,*args):
		...
		if self.cantidad_descargando < self.max_descargas:
			...
			dialog = Gtk.MessageDialog(self.builder.get_object("puesmiauWindow"), 0, Gtk.MessageType.INFO,
	...
	def __init__(self):
		...
		#Ventana Principal
		_window = self.builder.get_object("puesmiauWindow")
